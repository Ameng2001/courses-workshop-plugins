...
> 基于 [Claude Code Plugin](https://claude.ai/code) 体系构建，使用 [Astra Studio](https://github.com/VanLengs/astra-studio-plugins) 工具链开发。
...
- [Astra Studio 插件](https://github.com/VanLengs/astra-studio-plugins) 已添加为 marketplace
...
claude plugin install workshop-insight@course-workshop-plugins
claude plugin install workshop-designer@course-workshop-plugins
claude plugin install workshop-quality@course-workshop-plugins
claude plugin install workshop-resource@course-workshop-plugins
```
