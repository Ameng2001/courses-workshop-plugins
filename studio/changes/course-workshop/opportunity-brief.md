...
|-----------------|-------------|-------------------|---------------|-----------|
| workshop-designer | 5 | 4 | **20** | 覆盖 HS-1(驱动问题) + HS-2(活动设计) — 两个最大痛点。AI 擅长结构化生成 |
...
| 2 | **workshop-designer** | 紧跟 | 大（5-6 skills） | workshop-core |
...
> workshop-designer 和 workshop-insight 可以并行开发（insight 无依赖）。
...
| workshop-designer | 活动内容生成可能过于模板化 | 生成骨架(结构+关键问题)而非完整内容，让课研主任填充创意部分 |
...
Phase 3 (Advanced):
  ...
  workshop-designer += network-map (网络图自动生成)
```
