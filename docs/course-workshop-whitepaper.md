...
| **workshop-pipelines** | 方法论管线 | 4 | 列出可用教学方法论管线、选择并激活管线 |
...
最小可用组合：
- **PBL**：workshop-core + workshop-pipelines + workshop-designer（3 个插件，10 个技能）
- **五步法**：workshop-core + workshop-pipelines + workshop-lesson（3 个插件，9 个技能）
