...
| **教学方法论切换** | 查看和选择不同教学方法论模板（PBL、五步法等） | workshop-templates |
...
| **workshop-templates** | 方法论模板 | 2 | 列出可用教学方法论模板、选择并激活模板 |
...
workshop-designer    依赖 workshop-core + workshop-templates（需要工作空间和方法论模板）
workshop-lesson      依赖 workshop-core + workshop-templates（需要工作空间和方法论模板）
workshop-planner     依赖 workshop-core + workshop-templates（需要工作空间和方法论模板）
...
```
    ...
    ▼        ▼                      ▼            ▼
  ┌────────────────┐  ┌───────────────┐  ┌──────────────┐
  │workshop-designer│  │workshop-lesson│  │workshop-planner│ ← 依赖 core + templates
  └────────────────┘  └───────────────┘  └──────────────┘
  ┌────────────────┐  ┌────────────────┐
...
| 4 | `template-list` | workshop-templates | 列出所有可用教学方法论模板及其流水线信息 | 低 |
| 5 | `template-select` | workshop-templates | 选择并激活教学方法论模板到当前工作区 | 低 |
...
Next steps:
  /workshop-templates:template-list — 查看可用教学方法论
...
使用 `/workshop-templates:template-list` 查看可用模板。PBL 适合跨领域整合探究项目（月度粒度），五步法适合单节课的结构化教学（课时粒度）。两种方法论可以在同一学期中混合使用。
